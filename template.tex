% LaTeX Document Template v1.1


% Changelog v1.1:
% Added labels to equations, tables, figure
% Replaced manual graphics insert with \begin{figure}
% Added a new package: todonotes
% Added an example with todonotes.
% Removed batman symbol
...
\usepackage{spverbatim} % Used for code text
\usepackage{todonotes} % Used for adding notes to document
...
\begin{document}
	...
	CONTENT OF ABSTRACT 
	\todo{Remember to write the absract!}
	\pagebreak
	...
	% Check LaTeX reference for how to manage a table.
		\begin{figure}[!htbp] %Example figure, center and import from the images directory.
			\centering
	...
	\begin{itemize}
		\item An item 
		\item An inline equation $ba = ab$, see equation \ref{eq:example} % Item list example.
	\end{itemize}
